                    ...
                    <?php
                      ...
                      echo "<div class='row'>";
                        ...
                        echo "<div class='col-sm-6 col-md-6 col-lg-6'>";
                          ...
                          echo "<input type='text' class='form-control' name='schedulestart' required Placeholder='e.g. 08:00' />";
                        ...
                        echo "<div class='col-sm-6 col-md-6 col-lg-6'>";
                          ...
                          echo "<input type='text' class='form-control' name='schedulefinish' required Placeholder='e.g. 16:30' />";
                      ...
                      if (isset($_POST['addSchedule'])) {
                        ...
                        $scheduledate = strtolower($_POST['scheduledate']);
                          
                        $schedulestart = strtolower($_POST['schedulestart']);
                        
                        $schedulefinish = strtolower($_POST['schedulefinish']);
